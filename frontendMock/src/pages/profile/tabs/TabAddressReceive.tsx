...
import {
  ...
  getReceiverById,
  updateReceiver,
  updateReceiverByDefaulAddress,
} from "../../../services/addressreceiver";
...
const TabAddressReceive: React.FC = () => {
  ...
  useEffect(() => {
    if (idUpdate) {
      getReceiverById(idUpdate).then((data: IRA) => {
        ...
        >
                      ...
                      >
                        <li className="py-2 list-none">
                          ...
                          <Radio
                            ...
                            onClick={() => setDefaultAddress(data.id)}
                          >
          ...
          >
            <Form form={form} onFinish={onFinish}>
              ...
              <Form.Item name="myCheckbox" valuePropName="checked">
          ...
          <Modal
            ...
            okText="Cập nhật"
          >
            <Form form={form2} onFinish={doUpdate}>
