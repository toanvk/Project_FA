    ...
    <div className="flex flex-col items-center justify-center py-20">
      ...
      >
        ...
        <Form.Item
          ...
          name="phone"
          rules={[
            { required: true, message: "Hãy nhập điện thoại!", pattern: phone },
          ]}
        >
        ...
        <Form.Item wrapperCol={{ offset: 8, span: 16 }}>
          <Button
            type="primary"
            className="bg-red-500 hover:bg-[#6d6d6d]"
            htmlType="submit"
          >
            Đăng ký
          </Button>
          <span
            ...
            className="ml-5 font-bold text-red-500 hover:text-red-400 cursor-pointer"
          >
            ĐĂNG NHẬP
          </span>
        </Form.Item>
