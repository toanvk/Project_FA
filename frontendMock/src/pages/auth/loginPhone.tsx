...
const PhoneAuth: React.FC = () => {
  ...
  const handleSendCode = async () => {
    try {
      if (
        !phoneNumber ||
        !phoneNumber.match(/^(84|0[3|5|7|8|9])+([0-9]{8})\b$/)
      ) {
  ...
  const handleVerifyCode = async () => {
    form
      ...
      .then(async (values: any) => {
        if (
          numberReg.test(values.num1) &&
          numberReg.test(values.num2) &&
          numberReg.test(values.num3) &&
          numberReg.test(values.num4) &&
          numberReg.test(values.num5) &&
          numberReg.test(values.num6)
        ) {
          let OTPCODE =
            values.num1 +
            values.num2 +
                ...
                <div className="flex flex-col space-y-16">
                  <div className="flex flex-row items-center justify-between mx-auto w-full space-x-4">
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[0] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                            handleInputChange(event.target.value, 0)
                          }
                          className="w-full h-full flex flex-col items-center justify-center text-center px-5 outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-red-700"
                        />
                      </div>
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[1] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[2] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[3] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[4] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                    ...
                    >
                      <div className="w-16 h-16 ">
                        <Input
                          ref={(ref) =>
                            (inputRefs.current[5] = ref ? ref.input : null)
                          }
                          onChange={(event) =>
                  ...
                  <div className="flex flex-col space-y-5">
                    <div>
                      <Button
                        htmlType="submit"
                        className="flex flex-row cursor-pointer items-center justify-center text-center w-full border rounded-xl outline-none py-5 bg-red-700 border-none text-white text-sm shadow-sm"
                      >
                        Verify Code
                      </Button>
                    </div>
