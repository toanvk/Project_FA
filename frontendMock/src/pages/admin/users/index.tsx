...
const Users: React.FC = () => {
  ...
  const buttonUpdate = async (username: string) => {
    await getUserInfo(username).then((data: IUser) => {
      setUserUpdate(data);
  ...
  useEffect(() => {
    if (userUpdate) form.setFieldsValue(formValue);
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <Space size="middle">
            <Button onClick={() => buttonUpdate(record.username)}>
              Update
            </Button>
            <Button
              danger
              onClick={() => buttonDelete(record.username, record.userRole)}
            >
              Delete
            </Button>
          </Space>
          ...
          {userUpdate && (
            ...
            >
              ...
              <Form.Item
                ...
                name="email"
                rules={[
                  { required: true, message: "Hãy nhập email!", type: "email" },
                ]}
              >
        ...
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <Form.Item
              ...
              rules={[{ required: true, message: "Hãy nhập role!" }]}
            >
              <Select labelInValue options={USER_ROLE} />
            </Form.Item>
