...
import AddMetadataGroup from "./pages/admin/metadataGroup/addMetadataGroup";
import MetadataGroups from "./pages/admin/metadataGroup";
import EditMetadataGroup from "./pages/admin/metadataGroup/editMetadatagroup";
    ...
    <div className="bg-[#f8f9fa] flex flex-col justify-between min-h-screen">
      <Routes>
        ...
        <Route element={<AdminLayout />}>
          ...
          <Route
            path={routes.ADMIN_BLOGCATEGORIES}
          ...
          <Route
            path={routes.ADMIN_METADATAGROUPS}
            element={<MetadataGroups />}
          />
          <Route
            path={routes.ADMIN_METADATAGROUPS_ADDNEW}
            element={<AddMetadataGroup />}
          />

          <Route
            path={routes.ADMIN_METADATAGROUPS_EDIT}
            element={<EditMetadataGroup />}
          />

          <Route
            path={routes.ADMIN_PRODUCTCATEGORIES}
            element={<ProductCategories />}
          />
          <Route
            path={routes.ADMIN_PRODUCTCATEGORIES_ADDNEW}
            element={<AddProductCategory />}
          />
          <Route
            path={routes.ADMIN_PRODUCTCATEGORIES_EDIT}
          ...
          <Route
            path={routes.ADMIN_SETTING_FOOTER}
            element={<SettingFooter />}
          />
        </Route>
      </Routes>
    </div>
